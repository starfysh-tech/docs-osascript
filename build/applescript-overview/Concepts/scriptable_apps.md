...
* The underlying support in OS X for creating scriptable applications and working with Apple events is provided by the Open Scripting Architecture, and is described in [The Parts of the Open Scripting Architecture](osa.md#//apple_ref/doc/uid/TP40001571-1147859).
...
Starting in OS X version 10.5, the [Scripting Bridge](scripting_bridge.md#//apple_ref/doc/uid/TP40006467-SW1) technology provides an efficient way for Cocoa applications to interact with scriptable applications at a high level—that is, without having to construct or parse individual Apple events.
