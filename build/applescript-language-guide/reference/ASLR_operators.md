...
For related information, see the `reference` class and [Object Specifiers](../conceptual/ASLR_fundamentals.html#//apple_ref/doc/uid/TP40000983-CH218-SW7).
...
The `as` operator converts, or *coerces*, a value of one class to a value of another class. Not all values are coercible to all classes; see [Coercion (Object Conversion)](../conceptual/ASLR_fundamentals.html#//apple_ref/doc/uid/TP40000983-CH218-SW21) for a list of allowed coercions.
